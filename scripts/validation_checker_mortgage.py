    ...
    validation = {
        ...
        'Bank_Name': {
            ...
            'allowed': ['The Co-operative Bank', 'Bank of Ireland', 'Bank of Scotland', 'Halifax', 'Lloyds Bank',
                        'NatWest', 'Royal Bank Of Scotland', 'Virgin Money Plc.','Barclays','Clydesdale Bank','HSBC','Metro Bank','Santander Bank','TSB'],
            'required': True
        },
        'Ticker': {
            'type': 'string',
            'allowed': ['Private', 'BIRG', 'Private', 'Private', 'LLOY', 'NWBD', 'RBS', 'VM','BARC','CYBG','HSBA','MTRO','Private','Private'],
            'required': True
        },
        'Bank_Local_Currency': {
            'type': 'string',
        ...
        'Bank_Product_Code': {
            'type': 'string',
            'allowed': ['_YMF','10YMV', '15YMV', '25YMV', '30YMV', '10YMF', '15YMF', '25YMF', '30YMF', '20YMF'],
            'required': True
        },
        'Bank_Product_Name': {
            'type': 'string',
        ...
        'Mortgage_Loan_Amt': {
            'type': 'float',
            'allowed': [72000.0, 216000.0, 360000.0],
            'skip': [''],
            'required': True
        },
        ...
        'Mortgage_Category': {
            'type': 'string',
            'allowed': ['New Purchase','Existing Customers'],
            'strip': [' '],
            'required': True
        },
        'Mortgage_Reason': {
        ...
        'Fixed_Rate_Term': {
            'type': 'float',
            'allowed': [1.0, 2.0, 3.0, 5.0, 7.0, 10.0],
            'skip': ['']
        },
        ...
        'match': {
            ...
            'match_list': [['The Co-operative Bank', 'Private'], ['Bank of Ireland', 'BIRG'],
                           ...
                           ['Barclays','BARC'],['Clydesdale Bank','CYBG'],['HSBC','HSBA'],['Metro Bank','MTRO'],['TSB','Private']
                           ]
        },

    }
    path = UK+'UK_FINAL_Mortgage_Data_{}.csv'.format(now.strftime("%Y_%m_%d"))
    output = UK+'error_mortgage_UK.csv'
