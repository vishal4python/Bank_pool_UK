...
UK = path.join(path.dirname(path.dirname(path.realpath(__file__))), "data\output\\UK\\")
# final_cosolidation = path.join(path.dirname(path.dirname(path.realpath(__file__))), "data\output\UK\\")
