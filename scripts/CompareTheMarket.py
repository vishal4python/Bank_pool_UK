...
#CSV File Location
path = output_path + "Aggregator_Comparethemarket_Data_Deposit_"+today.strftime("%m_%d_%Y")+".csv"
...
#FIltering Bank Name using neededUkBanks
...
for url in urlList:
    ...
    #Scraping Required Data using BeautifulSoup Module
...
order = ["Date", "Bank_Native_Country", "State", "Bank_Name", "Bank_Local_Currency", "Bank_Type", "Bank_Product", "Bank_Product_Type", "Bank_Product_Code", "Bank_Product_Name", "Balance", "Bank_Offer_Feature", "Term_in_Months", "Interest_Type", "Interest", "AER", "Source"]
