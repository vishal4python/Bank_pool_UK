...
if __name__ == '__main__':
    validation = {
        ...
        'Bank_Name':{
            'type':'string',
            'allowed':['The Co-operative Bank', 'Bank of Ireland', 'Bank of Scotland', 'Halifax', 'Lloyds Bank', 'NatWest', 'Royal Bank Of Scotland', 'Virgin Money Plc','Barclays','Clydesdale Bank','HSBC','Metro Bank','Santander Bank','TSB','Virgin Money Plc.',''],
            'required':True
        },
        'Ticker':{
            'type':'string',
            'allowed':['Private', 'BIRG', 'Private', 'Private', 'LLOY', 'NWBD', 'RBS', 'VM','BARC','CYBG','HSBA','MTRO',''],
            'required':True
        },
        'Bank_Local_Currency':{
            'type':'string',
    ...
    path = UK+'UK_FINAL_Deposits_Data_{}.csv'.format(now.strftime("%Y_%m_%d"))
    output = UK+'error_deposit_UK.csv'
